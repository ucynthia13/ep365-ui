    ...
    >
      <div className="flex flex-col container max-w-5xl mx-auto">
        <div className="flex flex-col justify-center items-center gap-4">
          ...
          <h1 className="font-bold text-6xl text-primary-foreground max-w-md mx-auto">
            The Smarter Way to Manage Procurement
          </h1>
          <p className="font-medium text-primary-foreground max-w-md mx-auto">
          ...
          <Button className="bg-primary/50 font-medium text-sm">
            Book a Demo
          </Button>
        </div>
        <div className="flex">
