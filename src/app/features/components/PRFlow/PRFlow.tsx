...
const PRFlow = () => {
  ...
  return (
    <section className="relative z-10 overflow-hidden pt-16 md:pt-24 lg:pt-32 pb-12 sm:pb-16 lg:pb-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="mt-4 text-gray-600">
            With EP365&apos;s purchase requisition software, streamline your PR
            process, reduce manual effort, and free up your team for high-value
            tasks. Eliminate repetitive spreadsheet work and accelerate request
            cycles with automation. Discover how our PR software transforms
            procurement efficiency and boosts productivity across your
            organization.
          </p>
        </div>
