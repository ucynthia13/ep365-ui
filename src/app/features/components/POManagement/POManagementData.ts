export const features = [
  {
    title: "Turn PRs into POs in a Click",
    description:
    ...
    bg: "bg-blue-50",
    imageSrc: "/images/featuresPage/thumbnail_icon_1_89f132c05c.webp.svg",
  },
  {
  ...
  {
    title: "Instant Approvals, Zero Delays",
    description:
      "Keep your team in the loop with instant purchase order and email alerts for pending documents.",
    bg: "bg-blue-100",
    imageSrc: "/images/featuresPage/desktop_budget_overruns_5d52a0561b.webp.svg"
  },
  {
  ...
  {
    title: "Configure Multi-Step PO Approvals",
    description:
    ...
    bg: "bg-green-50",
    imageSrc: "/images/featuresPage/desktop_three_way_matching_5e633d6955.webp.svg"
  },
  {
  ...
  {
    title: "Remote Access to Every Purchasing File",
    description:
    ...
    bg: "bg-blue-50",
    imageSrc: "/images/featuresPage/thumbnail_icons_3_2de6f6cccc.webp.svg"
  },
];
