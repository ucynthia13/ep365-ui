...
const items = [
    ...
    header: (
      <div className="p-6 grid grid-cols-1 sm:grid-cols-3 gap-6 justify-center items-center">
        <div className="mb-6 sm:mb-0">
          <h2 className="text-2xl font-bold text-white mb-2">Procurement built with your business in mind</h2>
  ...
  },
  {
    ...
    header: (
      <div className="p-6 h-full flex flex-col">
        <div className="mb-4">
          <h3 className="text-lg font-bold text-white mb-2">Procurement from anywhere</h3>
        </div>
        <div className="flex justify-between items-center">
          <p className="text-slate-300 text-sm">Empower your team to create, track, and approve procurement workflows securely from any device.</p>
          <Image
  ...
  },
  {
    ...
    header: (
      <div className="p-6 h-full flex flex-col">
        <div className="mb-4">
          <h3 className="text-lg font-bold text-white mb-2">Smooth sync with your core systems</h3>
  ...
  },
  {
    ...
    header: (
      <div className="p-6 h-full flex flex-col">
        <div className="mb-4">
          <h3 className="text-lg font-bold text-white mb-2">Leading with innovation</h3>
  ...
  },
  {
    ...
    header: (
      <div className="p-6 h-full flex flex-col">
        <div className="mb-4">
          <h3 className="text-lg font-bold text-white mb-2">Customization for your business</h3>
  ...
  },
  {
    ...
    header: (
      <div className="p-6 h-full flex flex-col">
        <div className="mb-4">
          <h3 className="text-lg font-bold text-white mb-2">Enterprise-grade security & compliance</h3>
