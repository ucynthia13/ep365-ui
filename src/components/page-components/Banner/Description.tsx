...
const Description = () => {
  return (
    <section id="description" className="relative z-10 pt-16 md:pt-20 lg:pt-24">
      <motion.div
        initial="hidden"
        whileInView="visible"
        viewport={{ once: false }}
        className="max-w-5xl mx-auto rounded-2xl flex justify-between bg-gradient-to-tr from-white via-white to-primary/30"
      >
        ...
        <div className="py-4">
          <Image src="/images/banner/Procurify-AI-designed-for-procurement.webp.svg" className="h-max" width={400} height={400} alt="Banner Image"/>
        </div>
      </motion.div>
    </section>
  );
